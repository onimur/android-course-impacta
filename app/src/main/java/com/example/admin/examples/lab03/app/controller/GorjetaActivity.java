...
package com.example.admin.examples.lab03.app.controller;
...
import com.example.admin.examples.lab01.design.pattern.TextWatcherAdapter;
import com.example.admin.examples.lab03.domain.model.Gorjeta;

import static com.example.admin.examples.lab01.app.controller.Constantes.CLIPBOARD_GORJETA;
...
public class GorjetaActivity extends MainUtilitiesActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setOnLongClickAction(R.id.lab03_et_gorjeta_1, new copyToClipboardAction(CLIPBOARD_GORJETA, R.string.lab03_copy));
        setOnLongClickAction(R.id.lab03_et_gorjeta_2, new copyToClipboardAction(CLIPBOARD_GORJETA, R.string.lab03_copy));
        setOnLongClickAction(R.id.lab03_et_gorjeta_3, new copyToClipboardAction(CLIPBOARD_GORJETA, R.string.lab03_copy));

        setOnLongClickAction(R.id.lab03_et_valor_1, new copyToClipboardAction(CLIPBOARD_GORJETA, R.string.lab03_copy));
        setOnLongClickAction(R.id.lab03_et_valor_2, new copyToClipboardAction(CLIPBOARD_GORJETA, R.string.lab03_copy));
        setOnLongClickAction(R.id.lab03_et_valor_3, new copyToClipboardAction(CLIPBOARD_GORJETA, R.string.lab03_copy));

        setOnLongClickAction(R.id.lab03_et_gorjeta_def, new copyToClipboardAction(CLIPBOARD_GORJETA, R.string.lab03_copy));
        setOnLongClickAction(R.id.lab03_et_valor_def, new copyToClipboardAction(CLIPBOARD_GORJETA, R.string.lab03_copy));
