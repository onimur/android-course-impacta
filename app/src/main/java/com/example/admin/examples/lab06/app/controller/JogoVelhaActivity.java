package com.example.admin.examples.lab06.app.controller;
...
public class JogoVelhaActivity extends MainUtilitiesActivity implements View.OnClickListener {
    ...
    private void enviaPontosAtualizados() {
        textViewPlayer1.setText(String.valueOf(getString(R.string.player_1) + player1Points));
        textViewPlayer2.setText(String.valueOf(getString(R.string.player_2) + player2Points));
    }
